...
class PPO(RL_Learner, Safe_nn_Module):
    ...
    def learn(self, 
        ...
        aux: np array of shape (batch_size, context_length + 1, cause_size)
        ...
        b_causes = convert_list_of_np_array_to_int_tensor(aux, self.device) if aux is not None else None
